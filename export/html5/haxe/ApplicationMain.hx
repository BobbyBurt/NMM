...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PlatformerCool", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PlatformerCool", null, 1330, 640);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PlatformerCool";
		app.meta["name"] = "PlatformerCool";
